...
public class ItemUtils {
    ...
    public static ItemStack none = ItemUtils.item(Material.REDSTONE_BLOCK, "§c");
    ...
    public static ItemStack itemSeparator(DyeColor color) {
        return item(Material.valueOf(color.name() + "_STAINED_GLASS_PANE"), "Â§a");
    }
    ...
    public static ItemStack itemSwitch(String name, boolean enabled, String... lore) {
        return item(enabled ? Material.SLIME_BALL : Material.FIREWORK_STAR, (enabled ? "§a" : "§7") + name, lore);
    }
    ...
    public static boolean set(ItemStack itemSwitch, boolean enable) {
        ...
        itemSwitch.setType(enable ? Material.SLIME_BALL : Material.FIREWORK_STAR);
        return enable;
    }
}