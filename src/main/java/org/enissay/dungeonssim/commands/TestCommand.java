...
public class TestCommand {
    ...
    void test(@Context CommandSender sender, @Arg int MIN_ROOM, @Arg int MAX_ROOM) {
        if (sender instanceof Player) {
            ...
            final Generator2D generator2D = new Generator2D(dungeonGeneration, dungeonGeneration.getGridHeight(), dungeonGeneration.getGridWidth(), dungeonGeneration.getGridMap(), dungeonGeneration.getGridBlocks(), roomNames);
